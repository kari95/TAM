...
class OldMainActivity: AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
  ...
  lateinit var binding: OldActivityMainBinding
  lateinit var viewModelOld: OldMainViewModel
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    binding = DataBindingUtil.setContentView(this, R.layout.old_activity_main)
    viewModelOld = ViewModelProviders.of(this).get(OldMainViewModel::class.java)

    binding.viewModel = viewModelOld
  ...
  override fun onNavigationItemSelected(item: MenuItem): Boolean {
    ...
    when (item.itemId) {
      R.id.nav_meals -> {
        viewModelOld.onMealsClick()
      }
      R.id.nav_sign_in -> {
        viewModelOld.onSignInClick()
      }
    }
  ...
  private fun setupListeners() {
    ...
    viewModelOld.meals.observe(this, Observer { meals ->
      if (meals == null)
        return@Observer
      adapter.meals = meals
    })
