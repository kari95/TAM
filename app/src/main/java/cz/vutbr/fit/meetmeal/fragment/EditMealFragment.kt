...
class EditMealFragment: Fragment() {
  ...
  lateinit var binding: FragmentEditMealBinding
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
    ...
    binding = DataBindingUtil.inflate(inflater, R.layout.fragment_edit_meal, container, false)
    return binding.root
  }
  ...
  private fun addListeners() {
    ...
    binding.editMealSaveButton.setOnClickListener { _ ->
